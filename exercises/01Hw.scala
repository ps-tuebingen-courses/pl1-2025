...
object Hw01 {
  ...
  /** Tasks:
    *
    * 1) Implement the missing parts of the interpreter for these formulae (the
    * eval function). Test the correctness by evaluating the example proposition
    * given below and add at least two more examples and test against these.
    *
    * 2) Add implication as a new kind of expression "Impl" and extend the
    * interpreter accordingly. Add at least two examples for testing.
    */
